; Function: rm_load_raw_hook  (custom)
...
.ifdef RM
  ...
  /* 0x80402040 */  bne $v1, $v0, .rm_load_raw_hook_L804021C8  ; <-- CHANGED
  ...
  /* 0x80402088 */  beq $v0, $zero, .rm_load_raw_hook_L80402200  ; <-- CHANGED
  ...
  /* 0x804020E0 */  j .rm_load_raw_hook_L80402200  ; <-- CHANGED
  ...
  /* 0x80402118 */  j .rm_load_raw_hook_L80402200  ; <-- CHANGED
  ...
  /* 0x80402150 */  j .rm_load_raw_hook_L80402200  ; <-- CHANGED
  ...
  /* 0x80402188 */  j .rm_load_raw_hook_L80402200  ; <-- CHANGED
  ...
  /* 0x804021C0 */  j .rm_load_raw_hook_L80402200  ; <-- CHANGED
  /* 0x804021C4 */  sw $v0, 0($v1)  ; <-- CHANGED
.rm_load_raw_hook_L804021C8:
...
; ── Changed instructions ────────────────────────────────────
  ...
  ; 0x80402040:
  ;   was: 01 01 01 01  .word 0x01010101  // unknown SPECIAL funct=0x01
  ;   new: 14 62 00 61  bne $v1, $v0, .rm_load_raw_hook_L804021C8
  ; 0x80402044:
  ;   was: 01 01 01 01  .word 0x01010101  // unknown SPECIAL funct=0x01
  ;   new: 00 00 00 00  nop
  ; 0x80402048:
  ...
  ; 0x80402088:
  ;   was: 01 01 01 01  .word 0x01010101  // unknown SPECIAL funct=0x01
  ;   new: 10 40 00 5D  beq $v0, $zero, .rm_load_raw_hook_L80402200
  ; 0x8040208C:
  ;   was: 01 01 01 01  .word 0x01010101  // unknown SPECIAL funct=0x01
  ;   new: 00 00 00 00  nop
  ; 0x80402090:
  ...
  ; 0x804020E0:
  ;   was: 01 01 01 01  .word 0x01010101  // unknown SPECIAL funct=0x01
  ;   new: 08 10 08 80  j .rm_load_raw_hook_L80402200
  ; 0x804020E4:
  ;   was: 01 01 01 01  .word 0x01010101  // unknown SPECIAL funct=0x01
